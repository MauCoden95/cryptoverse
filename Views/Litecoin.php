<?php
	...
	<section>
		<h2 class="section_title">Comprar Litecoins</h2>
		<div class="center">
			

			<form class="buy" action="http://localhost/cryptoverse/?controller=wallet&action=buyingLitecoin" method="POST">
				...
				<div class="prices_div">
					...
					<div>
						<div><img src="http://localhost/cryptoverse/Assets/Img/ARS.png"> <span class="price_ltc--ars"></span> $</div>
					</div>
					...
					<input type="text" name="receive" class="input_calc input_calc_ltc" placeholder="Recibiré">
