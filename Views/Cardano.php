<?php
	...
	<section>
		<h2 class="section_title">Comprar Cardanos</h2>
		<div class="center">
			

			<form class="buy" action="http://localhost/cryptoverse/?controller=wallet&action=buyingCardano" method="POST">
				...
				<div class="prices_div">
					...
					<div>
						<div><img src="http://localhost/cryptoverse/Assets/Img/ARS.png"> <span class="price_ada--ars"></span> $</div>
					</div>
					...
					<input type="text" name="receive" class="input_calc input_calc_ada" placeholder="Recibiré">
